...
if (cmd === 'next') {
  ...
  console.log('用法: next | done --seq N [--firstPass true] [--optimal true] [--notes "..."] [--verdict ... --testcases ... --memory ... --approach ... --time ... --space ...] | habit add|list | analysis --slug <slug> | hint --category <分类> | stats');
}
